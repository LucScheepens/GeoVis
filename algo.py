...
class DummyAlgorithm(LayoutAlgorithm):
    ...
    def find_optimal_layout(self, flow_paths: FlowPathsT, stations: dict[str, Point]) -> LayoutOutput:
        ...
        slot_coordinates = {}
        print('slots: {}, offsets: {}'.format(SLOTS, SLOT_OFFSETS))
...
class DynamicRanges(LayoutOutput):
    @property
    def name(self):
        return 'DynamicRanges'
    
    def find_optimal_layout(self, flow_paths, stations):
        intersections_test , paths_dummy , layout= calculate_intersections(flow_paths, stations)
